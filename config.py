...
main = {
    ...
    'dr6' : None,
    # digital input name
    'dn1' : 'Porta',         # contatto porta
    'dn2' : 'Alimentazione', # contatto alimentazione
    'dn3' : 'Temperatura',   # contatto temperatura alta
    'dn4' : 'Flusso',        # contatto flusso sonda
    'dn5' : None,
    'dn6' : None,
